...
|-----------------------------------------------|------------------------------------|------------------|--------------------------|------------------------------|
| Termopar tipo T                               | Temperatura Ambiente               | ICSP             | Arduino UNO R4 WiFi      | PWFusion MAX31856 SEN-30007	 |
| TPF1/E-20 PT1000                              | Temperatura Radiante               | ICSP             | Arduino UNO R4 WiFi      | Adafruit PT1000 RTD-MAX31865 |
| Wind Sensor Rev P6                            | Velocidad del Viento		           | ADC              | Arduino UNO R4 WiFi        |				               |
...
En la construcción del DTHIS se emplea un termopar tipo T, un sensor de temperatura compuesto por la unión de cobre y cobre-níquel. Su uso es ideal para aplicaciones de baja temperatura y criogénicas, así como para entornos con humedad.  
