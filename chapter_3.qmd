...
En la tabla @tbl-componentes se muestran los sensores y componentes electrónicos que conforman al DTHIS-C.
...
La tabla @tbl-materiales muestra la lista de materiales necesarios para la construcción del DTHIS-C, detallando la cantidad de cada componente, los costos y la fuente de venta.
...
| Arduino                     | Arduino UNO WiFi Rev2                                                 | 2            | $1,268.10                | $2,536.20             | [AG Electrónica](https://www.agelectronica.com/detalle?busca=ABX00021)                                                                                           |
...
| Raspberry                   | Raspberry Pi 4 Model B 8 GB                                           | 1            | $1,990.52                | $1,990.52             | [AG Electrónica](https://www.agelectronica.com/detalle?busca=RASPBERRYPI-4-MODB%sum-8GB)                                                                         |
