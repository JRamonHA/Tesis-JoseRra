...
A continuación se muestra el código de Python empleado para us
...
En este capítulo se detalla el proceso de calibración y caracterización
...
Dado que cada sensor mide variables físicas de forma particular, se han
diseñado campañas de calibración y referenciación adaptadas a las
características propias de cada instrumento. Este proceso responde a la
necesidad de garantizar la exactitud, confiabilidad y trazabilidad de
...
Para ello, se definieron procedimientos estandarizados apoyados en
equipos de referencia certificados, lo que facilita la detección y
corrección de desviaciones inherentes a cada sensor, asegurando
resultados consistentes tanto en condiciones controladas como en
...
A continuación se muestra en la Tabla~\ref{tbl-instrumentos} la
información de los sensores y sus respectivos instrumentos de referencia
utilizados para la calibración y referenciación:
...
TPF1/E-20 PT1000 & Quest Technologies QUESTemp 32 & Temperatura
radiante \\
Wind Sensor Rev P6 & Gill Instruments WindMaster & Velocidad del
viento \\
SCD30 Sensirion & Fluke 975 AirMeter & CO2 y humedad relativa \\
5MP OV5647 Wide Angle Fisheye Camera & & Luminancia \\
Micrófono ambiental USB & & Sonido \\
\end{longtable}

\section{Visualización y obtención de los
datos}\label{visualizaciuxf3n-y-obtenciuxf3n-de-los-datos}
