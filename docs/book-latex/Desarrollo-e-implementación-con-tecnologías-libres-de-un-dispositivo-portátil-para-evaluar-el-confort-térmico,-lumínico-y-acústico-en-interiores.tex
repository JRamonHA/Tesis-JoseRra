...
Para ello, se definieron procedimientos apoyados en equipos de
...
\caption{\label{fig-termopares-a}Rangos de temperatura utilizados para
la calibración de los termopares.}
...
\caption{\label{fig-radiante-a}Intervalo de medición del QUESTemp 32 y
el TPF1 para su calibración.}
...
\caption{\label{fig-viento-a}Comparación de la velocidad del viento
...
\caption{\label{fig-calidad-a}Comparación de las mediciones del Fluke y
el SCD30 durante su campaña de referenciación.}
...
\caption{\label{fig-termopares-b}Resultados de las mediciones de
...
\caption{\label{fig-radiante-b}Comparación de las mediciones del
QUESTemp 32, el TPF1 y sus datos tras la calibración.}
...
\caption{\label{fig-viento-b}Comparación de las mediciones de velocidad
...
\caption{\label{fig-calidad-b}Correlación de las mediciones de
temperatura, humedad relativa y CO2 entre el Fluke y el SCD30.}
